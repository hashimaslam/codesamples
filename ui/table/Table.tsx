...
const TableComponent = <TData extends object>({
  ...
  return (
    <div className='overflow-hidden rounded-md border-1.5 border-slate-200 shadow-1'>
      <Table.TableRoot>
        <Table.TableHeader>
                ...
                return (
                  <Table.TableHead
                    ...
                    className={cn({
                      ...
                      'sticky w-50 min-w-50 max-w-50 truncate': isPinned
                    })}
                  >
                  ...
                  return (
                    <Table.TableCell
                      ...
                      className={cn('whitespace-nowrap bg-white', {
                        'sticky w-50 min-w-50 max-w-50 truncate': isPinned,
                        'cursor-pointer group-hover:bg-yellow-50':
                          Boolean(onRowClick)
                      })}
                    >
                      {flexRender(
