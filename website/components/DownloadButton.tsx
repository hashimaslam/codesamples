  ...
  <div>
    {!currentState ? (
      <div
        ...
        onClick={() => {
          downloadAction(androidDownloadStateOverlay);
        }}
      >
        <h4>Get ₹50 Bonus Cash</h4>
      </div>
    ) : (
...
export default class extends Component {
  ...
  performTwoAction(changeState, pixelSetup) {
    pixelSetup();
    changeState();
  }
  downloadAction = (androidDownload) => {
    androidDownload();
  };
        ...
        {({
          ...
          <div>
            {this.props.type === "overlay" ? (
              <OvelayDownloadButton
                downloadAction={this.downloadAction}
                androidDownloadStateOverlay={androidDownloadStateOverlay}
                ...
                {this.state.showDownload ? (
                  <div>
                    {this.state.osType === "android" ? (
                        ...
                        {!currentState ? (
                          ...
                          >
                            ...
                            >
                              <div>
                                <img
                                  src={imgRef.ANDROID_DOWNLOAD_MOBILE}
                                  alt=""
                                />
                              </div>
                      ...
                      <a
                        onClick={() => {
                          this.performTwoAction(changeState, this.pixelSetup);
                        }}
                      >
                        <img
                          id="ios_app"
